...
export function initSection1() {
  const mapConfigsS1 = [
    ...
    },
    {
      ...
      address: '서울특별시 중구 세종대로 99 (덕수궁 대한문)',
      ...
      desc: '1919년 2월 8일 일본 도쿄의 기독교청년회관에서 조선인 유학생들이 발표한 독립선언서이다. 한일 병합조약 폐지와 조선의 독립 선언, 민족대회 소집과 만국평화회의에 민족대표 파견을 요구했다.',
      imgUrl: '/assets/images/역사편찬원/3.1운동(1차)/203_2.8독립선언서(국가지정기록물_독립기념관).jpg',
      caption: '2.8독립선언서'
    },
    {
      id: 'map-s1-4', center: [48.8566, 2.3522], zoom: 8, title: '프랑스 파리', region: 'global',
      address: '프랑스 파리 (제1차 세계대전 파리 강화 회의장)',
      desc: '파리강화회의 한국대표 특사 김규식이 미국대통령 윌슨에게 보낸 편지이다. 일제의 주권 찬탈을 폭로하고, 한국 독립의 정당성과 당위성을 주장했다.',
  ...
  mapConfigsS1.forEach(config => {
    ...
    targetPoint.y -= 190; // 이 숫자를 키울수록 마커가 화면 아래로 더 많이 내려갑니다. (150~300 사이 조절 권장)
